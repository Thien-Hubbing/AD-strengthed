...
export const singularityMilestones = {
  ...
  continuumMult: {
    ...
    effect: completions => Decimal.mul(completions, 0.05),
  ...
  darkMatterMult: {
    ...
    effect: completions => Decimal.pow(5, completions),
  ...
  darkEnergyMult: {
    ...
    effect: completions => Decimal.pow(3, completions),
  ...
  darkDimensionCostReduction: {
    ...
    effect: completions => Decimal.pow(0.25, completions),
  ...
  singularityMult: {
    ...
    effect: completions => Decimal.pow(4, completions),
  ...
  darkDimensionIntervalReduction: {
    ...
    effect: completions => Decimal.pow(0.35, completions),
    effectFormat: x => `/ ${format(x.recip(), 2, 2)}`,
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  improvedAscensionDM: {
    ...
    effect: completions => Decimal.pow(10, completions),
  ...
  realityDEMultiplier: {
    ...
    effect: completions => Decimal.pow(completions, Laitela.difficultyTier),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  ...
  intervalCostScalingReduction: {
    ...
    effect: completions => completions.mul(0.05).sub(1).neg(),
  ...
  darkFromTesseracts: {
    ...
    effect: () => Decimal.pow(3, Tesseracts.effectiveCount),
    effectFormat: x => formatX(x, 2, 2),
  ...
  multFromInfinitied: {
    ...
    effect: () => Decimal.clampMin(Currency.infinitiesTotal.value.max(1).log10().div(600), 1),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  dilatedTimeFromSingularities: {
    ...
    // it does so you need to softcap things
    effect: () => Currency.singularities.value.max(1).log10().div(100).add(1),
  ...
  darkFromGlyphLevel: {
    ...
    effect: () => Decimal.pow(Decimal.clampMin(player.records.bestReality.glyphLevel.div(1e3), 1), 0.8),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  gamespeedFromSingularities: {
    ...
    effect: () => Decimal.clampMin(Decimal.pow(Currency.singularities.value.max(1).log10(), 5), 1),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_MAIN,
  },
  darkFromTheorems: {
    ...
    effect: () => Decimal.clampMin(Currency.timeTheorems.value.max(1).log10().sub(1000).div(50), 1),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  dim4Generation: {
  ...
  darkFromDM4: {
    ...
    effect: () => Decimal.clampMin(DarkMatterDimension(4).amount.pow(0.05), 1),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  ...
  theoremPowerFromSingularities: {
    ...
    effect: () => Decimal.log10(Currency.singularities.value.add(1)).div(40).add(1),
  ...
  darkFromGamespeed: {
    ...
    effect: () => Decimal.clampMin(Decimal.log10(getGameSpeedupFactor().div(1e80)).div(40), 1),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  glyphLevelFromSingularities: {
    ...
    effect: () => Decimal.clampMin(Currency.singularities.value.max(1).log10().div(30), 0).add(1),
  ...
  darkFromDilatedTime: {
    ...
    effect: () => Decimal.pow(1.6, Currency.dilatedTime.value.max(1).log10().div(200)),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  infinitiedPow: {
  ...
  tesseractMultFromSingularities: {
    ...
    effect: () => Currency.singularities.value.max(1).log10().div(50).add(1),
    effectFormat: x => formatX(Decimal.clampMin(x, 1), 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_MAIN,
  }
};
