...
export const normalAchievements = [
  ...
  },
  {
    ...
    get reward() { return `8th Antimatter Dimensions are ${formatX(9.99, 0, 2)} stronger.`; },
    effect: 9.999
  },
  {
    id: 24,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
    get reward() { return `1st Antimatter Dimensions are ${formatX(150)} stronger.`; },
    effect: 150
  },
  {
    id: 31,
  ...
  },
  {
    ...
    get reward() {
      ...
      (8th gets ${formatPow(new Decimal(1.08), 0, 2)}, 7th gets ${formatPow(new Decimal(1.07), 0, 2)}, etc.)`;
    }
  },
  {
    id: 44,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `Multiply starting tickspeed by ${formatX(29, 0, 2)}.`; },
    effect: 1 / 29
  },
  {
    id: 46,
  ...
  },
  {
    ...
    effect: () => new Decimal(3000).div(Time.thisInfinity.totalMinutes.times(100).add(3)).max(1),
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `Increase the multiplier for buying ${formatInt(10)} Antimatter Dimensions by +${formatPercents(0.5)}.`;
    },
    effect: 1.5
  },
  {
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Antimatter Dimensions 1-4 are ${formatX(25)} stronger.`; },
    effect: 25
  },
  {
    id: 65,
    ...
    effect: () => (Player.isInAnyChallenge ? Decimal.max(new Decimal(1e9).div(Time.thisInfinity.totalMinutes.times(1e8).add(1)), 1) : 1),
    effectCondition: () => Player.isInAnyChallenge && Time.thisInfinity.totalMinutes.lt(33),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 66,
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `Multiply starting tickspeed by ${formatX(58, 0, 2)}.`; },
    effect: 1 / 58
  },
  {
    id: 67,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `1st Antimatter Dimensions are ${formatX(10)} stronger.`; },
    effect: 10
  },
  {
    id: 71,
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `1st Antimatter Dimensions are ${formatInt(909)} times stronger.`; },
    effect: 909
  },
  {
    id: 72,
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `All Antimatter Dimensions are ${formatX(Math.log10(Number.MAX_VALUE), 0, 2)} stronger.`; },
    effect: Math.log10(Number.MAX_VALUE)
  },
  {
    id: 73,
    ...
    effect: () => Currency.antimatter.value.pow(0.00009).plus(1),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 74,
    ...
    checkEvent: [GAME_EVENT.BIG_CRUNCH_AFTER, GAME_EVENT.REALITY_RESET_AFTER],
    get reward() { return `All Antimatter Dimensions are ${formatPercents(5)} stronger, but only in challenges.`; },
    effect: 6,
  ...
  },
  {
    ...
    effect: () => Decimal.max(Decimal.pow(Time.totalTimePlayed.totalDays, 100), 1),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 77,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `Start with ${format(1e250)} antimatter.`;
    },
    effect: 1e250
  },
  {
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GALAXY_RESET_AFTER,
    get reward() { return `Tickspeed is ${formatX(2)} faster per Antimatter Galaxy.`; },
    effect: () => new Decimal(0.5).pow(player.galaxies),
  ...
  },
  {
    ...
    effect: () => Currency.antimatter.value.pow(0.00035).plus(1),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 85,
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Additional ${formatX(150)} multiplier to Infinity Points.`; },
    effect: 150
  },
  {
    id: 86,
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `All Galaxies are ${formatPercents(0.1)} stronger.`; },
    effect: 1.1
  },
  {
    id: 87,
    ...
    get reward() {
      ...
      give ${formatX(2e6)} more Infinities.`;
    },
    effect: 2e6,
  ...
  },
  {
    ...
    get reward() {
      ...
      first ${formatInt(200)} seconds of Infinities.`;
    },
    effect: () => Decimal.max((new Decimal(200).sub(Time.thisInfinity.totalSeconds)).pow(3), 1),
    effectCondition: () => Time.thisInfinity.totalSeconds.lt(200),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 92,
    ...
    effect: () => Decimal.max((new Decimal(20).sub(Time.thisInfinity.totalMinutes)).pow(7.5), 1),
    effectCondition: () => Time.thisInfinity.totalMinutes.lt(20),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 93,
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Additional ${formatX(300)} multiplier to Infinity Points.`; },
    effect: 300
  },
  {
    id: 94,
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `Multiply Infinity Power gain by ${formatX(260)}.`; },
    effect: 260
  },
  {
    id: 95,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
      return `Make the Infinity Point formula better. log(x)/${formatInt(308)} ➜ log(x)/${formatInt(300)}`;
    },
    effect: 300
  },
  {
    ...
    checkEvent: GAME_EVENT.ETERNITY_RESET_BEFORE,
    get reward() { return `Start Eternities with ${format(3e30)} Infinity Points.`; },
    effect: 3e30
  },
  {
    id: 105,
    ...
    effect: () => Tickspeed.perSecond.pow(0.0000308),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 106,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.DIMBOOST_AFTER,
    get reward() {
      return `The multiplier from Dimension Boosts to Antimatter Dimensions is ${formatPercents(7.5)} higher.`;
    },
    effect: 8.5
  },
  {
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    reward: "Time Dimensions are stronger based on how many Time Studies you have.",
    effect: () => Decimal.pow(10, player.timestudy.studies.length).max(1),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 131,
    ...
    get reward() {
      return `You gain ${formatX(2e9)} times more Infinities and
  ...
  },
  {
    ...
    effect: () => Decimal.max(Decimal.pow(player.galaxies, 3), 1).times(1.22),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 133,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `Gain ${formatX(260000, 2, 2)} Dilated Time and Time Theorems.`; },
    effect: () => 260000,
  },
  {
    id: 138,
  ...
  },
  {
    ...
    get reward() {
      return `${formatX(141)} Infinity Point gain, and increase the multiplier for buying ${formatInt(10)}
      Antimatter Dimensions by +${formatInt(5)}.`;
    },
    effects: {
      ipGain: 141,
      buyTenMult: 5
  ...
  },
  {
    ...
    get reward() { return `Dimension Boosts are ${formatX(100)} stronger.`; },
    effect: 100,
  },
  {
    id: 143,
  ...
  },
  {
    ...
    get reward() { return `Black Hole intervals are ${formatPercents(new Decimal(0.25))} shorter.`; },
    effect: 0.75
  },
  {
    id: 146,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.REALITY_RESET_BEFORE,
    get reward() { return `${formatPercents(new Decimal(0.75))} chance each Reality of ${formatX(2)} Realities and Perk Points.`; },
    effect: 0.75
  },
  {
    id: 155,
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `Black Hole durations are ${formatPercents(new Decimal(0.137))} longer.`; },
    effect: 1.137
  },
  {
    id: 156,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BLACK_HOLE_UPGRADE_BOUGHT,
    get reward() { return `Black Hole power increased by ${formatPercents(0.5)}.`; },
    effect: 1.5
  },
  {
    id: 161,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.REALITY_RESET_BEFORE,
    get reward() { return `+${formatInt(420)} to Glyph level.`; },
    effect: 420
  },
  {
    id: 167,
    ...
    effect: () => Decimal.clampMin(1, Currency.realityMachines.value.max(1).pow(0.1)),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 168,
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `Get ${formatX(50)} more memories.`; },
    effect: 50
  },
  {
    id: 171,
    ...
    checkEvent: GAME_EVENT.GLYPHS_CHANGED,
    get reward() { return `Glyph sacrifice is ${formatX(8)} stronger.`; },
    effect: 8,
  },
  {
    id: 172,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.REALITY_RESET_AFTER,
    get reward() {
      return `Synergism can go above ${formatPercents(new Decimal(1))} and Momentum increases ${formatX(100)} faster.`;
    },
    effect: 100,
  },
  {
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GALAXY_RESET_AFTER,
    get reward() { return `All Galaxies are ${formatPercents(new Decimal(0.05))} stronger.`; },
    effect: 1.05
  },
  {
    id: 181,
  ...
  },
  {
    ...
    get reward() { return `All Dimensions are raised to ${formatPow(1.0812403840463596, 0, 3)}`; },
