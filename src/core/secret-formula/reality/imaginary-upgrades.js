...
export const imaginaryUpgrades = [
  rebuyable({
    ...
    initialCost: 3,
    costMult: 60,
    description: () => `Increase Temporal Amplifier multiplier by +${format(0.35, 2, 2)}`,
    effect: 0.35
  }),
  rebuyable({
    ...
    initialCost: 4,
    costMult: 60,
    description: () => `Increase Replicative Amplifier multiplier by +${format(0.75, 2, 2)}`,
    effect: 0.75
  }),
  rebuyable({
    ...
    initialCost: 1,
    costMult: 40,
    description: () => `Increase Eternal Amplifier multiplier by +${format(0.8, 2, 2)}`,
    effect: 0.8
  }),
  rebuyable({
    ...
    initialCost: 5,
    costMult: 80,
    description: () => `Increase Superluminal Amplifier multiplier by +${format(0.4, 2, 2)}`,
    effect: 0.4
  }),
  rebuyable({
    ...
    initialCost: 1,
    costMult: 30,
    description: () => `Increase Boundless Amplifier multiplier by +${format(1.35, 2, 2)}`,
    effect: 1.35
  }),
  rebuyable({
  ...
  rebuyable({
    ...
    initialCost: 1e7,
    costMult: 4,
    description: () => `Multiply Infinity Dimensions by ${format("1e10000000")}`,
    effect: DC.E1E7,
    formatEffect: value => `${formatX(value)}`,
    isDecimal: true
  }),
  ...
  },
  {
    ...
    description: "Increase Imaginary Machine and Reality Machine Cap based on Imaginary Upgrades purchased",
    effect: () => ImaginaryUpgrades.totalRebuyables.add(1).mul(ImaginaryUpgrades.totalSinglePurchase * Math.E),
    formatEffect: value => `${formatX(value, 2, 2)} / ${formatPow(value.sqrt(), 2, 2)}`,
    isDisabledInDoomed: true
  },
  {
