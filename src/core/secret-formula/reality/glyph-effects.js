...
export const glyphEffects = {
  ...
  timespeed: {
    ...
    effect: (level, strength) => (GlyphAlteration.isEmpowered("time")
      ...
      : new Decimal(level).times(strength)).add(1),
    formatEffect: x => format(x, 3, 3),
  ...
  timeEP: {
    ...
    shortDesc: () => (GlyphAlteration.isAdded("time")
      ? "EP ×{value} and ^{value2}"
      : "EP ×{value}"),
    effect: (level, strength) => Decimal.pow(strength, level).times(100),
    formatEffect: x => format(x, 2, 3),
    combine: GlyphCombiner.multiply,
    conversion: x => Decimal.log10(x).add(1).sqrt(),
  ...
  dilationDT: {
    ...
    effect: (level, strength) => (GlyphAlteration.isEmpowered("dilation")
      ...
      : Decimal.pow(level, strength).times(2)),
  ...
  dilationTTgen: {
    ...
    shortDesc: () => (GlyphAlteration.isAdded("dilation")
      ...
      : "{value} TT/hr"),
    effect: (level, strength) => Decimal.pow(level, strength).div(10000),
  ...
  replicationspeed: {
    ...
    effect: (level, strength) => (GlyphAlteration.isEmpowered("replication")
      ? Decimal.pow(strength, level).times(10)
      : Decimal.pow(level.pow(2), strength.pow(2)).times(3)),
    formatEffect: x => format(x, 2, 1),
    combine: GlyphCombiner.multiplyDecimal,
  ...
  replicationpow: {
    ...
    effect: (level, strength) => Decimal.pow(level, 0.75).times(strength).div(25)
  ...
  infinitypow: {
    ...
    effect: (level, strength) => Decimal.pow(level, 0.25).times(Decimal.pow(strength, 0.5)).div(75)
  ...
  infinityrate: {
    ...
    effect: (level, strength) => Decimal.times(level, strength).pow(0.6).div(150),
    formatEffect: x => format(x, 2, 2),
    combine: GlyphCombiner.add,
    enabledInDoomed: true,
  },
  infinityIP: {
    ...
    shortDesc: () => (GlyphAlteration.isAdded("infinity")
      ? "IP ×{value} and ^{value2}"
      : "IP ×{value}"),
    effect: (level, strength) => Decimal.pow(strength, level.times(3)).times(1e4),
    formatEffect: x => format(x, 2, 3),
    combine: GlyphCombiner.multiply,
