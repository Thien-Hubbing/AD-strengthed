...
export const normalTimeStudies = [
  ...
  },
  {
    ...
    requirement: [11],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `The Replicanti interval limit is disabled but the cost gets exponentially higher.`,
    effect: 1e-300
  },
  {
    id: 31,
  ...
  },
  {
    ...
    reqType: TS_REQUIREMENT_TYPE.ALL,
    description: () => `You gain Replicanti ${formatInt(5)} times faster and the Replicanti chance is uncapped.`,
    effect: 5
  },
  {
    id: 71,
  ...
  },
  {
    ...
    requirement: [193],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `The Replicanti chance is raised to an exponent based on itself`,
    effect: () => ReplicantiUpgrade.chance.value.max(1).pow(0.85),
