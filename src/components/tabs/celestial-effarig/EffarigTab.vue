...
export default {
  ...
  methods: {
    update() {
      ...
      this.per10Mult.copyFrom(Effarig.per10MultBoost);
    ...
    <div class="l-effarig-shop-and-run">
      <div class="l-effarig-shop">
        <div class="c-effarig-relics">
          ...
          <span v-if="per10Mult.gt(1)">
            <br>
            The multiplier per 10 dimensions is also increased by {{ formatX(per10Mult, 2, 2) }}.
          </span>
        </div>
